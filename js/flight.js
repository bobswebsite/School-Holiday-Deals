...
async function functionLoad(){
    ...
    if(dat.Image!=null){document.getElementById("E11").innerHTML=`<a href="${dat.web}" target="_blank" class="d-block"><img src="${(dat.Image!=null)?dat.Image:null}" alt="plane-img"></a>`;}                                 
    else{document.getElementById("E11").innerHTML=``}
