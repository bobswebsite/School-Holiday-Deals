    ...
    for(var i=_i;i<nbrPage;i++){
        ...
        if(data[i].Dates != null){data[i].Dates=data[i].Dates.slice(0,10);}else{data[i].Dates=data[i].Datest};
          ...
          var rows=`<div class="deal-box">
								...
								:(Nome=='EASYJET')?'<img style="width:100%" src="images/EASYJET.png">':
								(Nome=='JET2HOLIDAYS')?'<img style="width:100%" src="/images/JET2HOLIDAYS.png">':''}
                            	</div>                             
                                <div class="top-box-right">
                                       	<div class="place"><span class="map-marker"><i class="la la-map-marker"></i></span> ${localStorage.getItem("To")}</div>  
                                       
                                </div>
                            	<div class="top-box-left">
									${(data[i].Image!=null)?'<img style="width:100%" src="'+data[i].Image+'" alt="flight-img">':''}
                            	</div>                             
                                <div class="top-box-right">
                                        ...
                                        <div class="price-text">
                                            <b><span class="price"><span  Style=" color: red; font-size:14px">${(data[i].Olde_price!=null)?'£'+data[i].Olde_price+'.00':''}</span><i class="${(data[i].New_price>data[i].Olde_price)?'icono-arrow2-up':(data[i].New_price<data[i].Olde_price)?'icono-arrow2-down':'icono-arrow2-down'}" style="color:${(data[i].New_price>data[i].Olde_price)?'red':(data[i].New_price<data[i].Olde_price)?'green':'grey'}"></i><span Style=" color: #287dfa; font-size:14px">£${(data[i].New_price!=null)?data[i].New_price:(data[i].Total_Price!=null)?data[i].Total_Price:data[i].Total}.00</span></span></b>
                                        </div>
                                         <div class="stars">
										    <span class="score">											 
								...
								<div class="depart-from">
                                    <i><b>${localStorage.getItem("From")}: ${data[i].From}</b></i>
                                </div>
